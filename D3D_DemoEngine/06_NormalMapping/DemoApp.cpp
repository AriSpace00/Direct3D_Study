...
bool DemoApp::InitScene()
{
    ...
    HR_T(CompileShaderFromFile(L"NormalMappingVS.hlsl", "main", "vs_4_0", &vertexShaderBuffer));
    if (FAILED(hr))
    {
    ...
    HR_T(CompileShaderFromFile(L"NormalMappingPS.hlsl", "main", "ps_4_0", &pixelShaderBuffer));
    if (FAILED(hr))
    {
